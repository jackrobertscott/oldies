...
class EmailManager extends Base
{
		...
		$this->emailStyle['header'] = '<html>
										<body style="background-color: #efefef;margin: 0;padding: 0;font-family: arial;">
											...
											<div style="background-color: #ffffff;margin: 10px auto;padding: 10px;width: 560px;-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius: 3px;">
												...
												<br><hr>';
		$this->emailStyle['footer'] = 			'<br>
												<p>Sincerely Yours,<br><br>'.COMPANYNAME.'<br><br><a href="'.WEBURLwTAGS.'" style="text-decoration: none;">'.WEBURL.'</a></p>
												<hr>
												...
												<p style="font-size: 10px;text-align: center;"><a href="'.WEBURLwTAGS.'unsubscribe.php" style="text-decoration:none;">Unsubscribe</a></p>
											</div>
	...
	*/
	public function verifyemail($verCode, $direction)
	{
		...
		$phpemail->Body      = $this->emailStyle['header'] .
				'<h4>Email Verification</h4>' .
				'<p>To verify your email adress follow the link below or enter the code in manualy.</p><br>' .
				'<a href="'.WEBURLwTAGS.'verify.php?verLinkCode=' . $verCode . '" style="text-decoration: none;margin: 0;padding: 0;">' .
